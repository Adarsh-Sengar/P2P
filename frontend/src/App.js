...
import {P2PInterface} from './P2P_sol_P2P_abi'
import {
  initBlockchain,
  setDriver,
  requestRide,
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const address = '0x90177421A2EC5c2209BE1478e81cE661Db6Ee180';

    const blockchainFunctions = await initBlockchain(portNumber, address, P2PInterface);
